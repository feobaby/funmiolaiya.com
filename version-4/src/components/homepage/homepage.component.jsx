      ...
      <div className="general-container">
            ...
            <div className="card-1">
              <div className="card-item-bio resMarLeft">
                ...
                <p className="bio-text">
                  I will be wrapping up my Masters in CS around August (2023) at
                  the&nbsp;
        ...
        <section>
          ...
          <ul className="cool-thing">
            <li className="listt">
              Currently, I felt like recreating my own version of this:{" "}
              <a
              ...
              , always check this link for the process:{" "}
              <a
                href="https://canal-street.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <u className="canal-street">Canal Street</u>.
              </a>
            </li>
            <li className="listt">
              ...
              >
                {" "}
                <u className="devcareer">DevCareer</u>
              </a>
              &nbsp;Cohort 2, in the aspect of back-end development. They ARE
              really working in cool places now! :)
            </li>
          </ul>
        </section>
        <br /> <br /> <br />
